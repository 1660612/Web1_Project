<form id="form" method="post" enctype="multipart/form-data" action="./pages/product/<?php isset($_GET['id']) ? $action = 'edit.php?id='.$_GET['id'] : $action = 'add.php'; echo $action; ?>" autocomplete="off">
    ...
    <label class="display-block float-left label-form">Mô tả:</label> <input type="text" name="description" class="display-block"/>
    <label class="display-block float-left label-form">Xuất xứ:</label> <input type="text" name="product_source" class="display-block"/>
