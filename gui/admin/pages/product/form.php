<div class="w-50 mx-auto">
    ...
    <form id="form" method="post" enctype="multipart/form-data" action="./pages/product/<?php echo isset($_GET['id']) ? $action = 'edit.php?id='.$_GET['id'] : $action = 'add.php'; ?>" autocomplete="off">
        <div class="form-group row">
            ...
            <input type="text" name="name" class="form-control col-sm-8" placeholder="Nhập tên sản phẩm..."/>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <input type="text" name="total_sale_count" class="form-control col-sm-8" placeholder="Nhập số lượng đã bán..."/>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <input type="text" name="price" class="form-control col-sm-8" placeholder="Nhập giá của sản phẩm..."/>
        </div>
        <div class="form-group row">
            <label class="d-block col-sm-4">Mô tả:</label>
            <textarea type="text" name="description" class="form-control col-sm-8" placeholder="Nhập mô tả sản phẩm..."></textarea>
        </div>
        <div class="form-group row">
